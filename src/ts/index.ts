...
const loadMore = document.querySelector<HTMLElement>('.load-more');
...
const headerShoppingCounter = document.querySelector<HTMLElement>('.header-shopping-counter');
...
document.body.addEventListener("click", (e: any) => {
  if (e.target.closest('.product-buy-button')) {
    clicks += 1;
    headerShoppingCounter.innerHTML = `${clicks}`;
  }
})
